...
**What {{COMPANY}} expects from a {{ROLE}}:**
...
**Day-to-Day:**
- Bullet points describing typical work
...
|---|---|---|
| Requirement from JD | DSA / System Design / Behavioral / Deep Dive | Your readiness note |

### Nice-to-Have (P1 — May give an edge)

| Requirement | Prep Area | Notes |
|---|---|---|
| Requirement from JD | Prep area | Note |
...
|---|---|---|
| Requirement | Matching resume experience | ⭐⭐⭐ / ⭐⭐ |

### High-Risk Gaps (Address in Prep)

| JD Requirement | Gap | Risk | Mitigation Strategy |
|---|---|---|---|
| Requirement | What's missing | 🔴 High | How to address it |

### Medium-Risk Gaps

| JD Requirement | Gap | Risk | Mitigation Strategy |
|---|---|---|---|
| Requirement | What's missing | 🟡 Medium | How to address it |

### Narrative Angles (How to Frame Your Experience)

- **Angle 1:** How to position existing experience to cover a gap
- **Angle 2:** Another framing strategy
...
|---|---|---|---|---|
| Round 1 | Screening / OA | ~60 min | DSA / MCQ | Platform, details |
| Round 2 | Technical | ~60 min | DSA / Coding | Expectations |
| Round 3 | System Design | ~60 min | HLD / LLD | Expectations |
| Round 4 | Behavioral | ~45 min | Leadership, Culture | Format |
| Round 5 | Hiring Manager | ~30 min | Career, Fit | Notes |

**Overall Timeline:** X weeks typical
...
| Theme | Why It Matters at {{COMPANY}} | Prep Priority |
|---|---|---|
| Project Leadership | Company-specific reason | 🔴 High |
| Technical Decision Making | Reason | 🔴 High |
| Mentoring & Growing Others | Reason | 🟡 Medium |
| Cross-Functional Collaboration | Reason | 🟡 Medium |
| Conflict Resolution | Reason | 🟡 Medium |
| Innovation & Impact | Reason | 🟡 Medium |
| Balancing Speed vs Quality | Reason | 🟡 Medium |
| Setting Standards | Reason | 🟡 Medium |
...
|---|---|---|---|
| 🔴 P0 | Area | X hours/week | Most critical topics |
| 🔴 P0 | Area | X hours/week | Topics |
| 🟡 P1 | Area | X hours/week | Topics |
| 🟢 P2 | Area | X hours/week | Topics |
...
- **Process duration:** X weeks typical
- **Offer rate:** X% (if available)
- **Key insight 1**
- **Key insight 2**
