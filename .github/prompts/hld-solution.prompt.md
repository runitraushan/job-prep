---
description: "Generate a complete High-Level Design (HLD) / System Design solution for a given problem. Creates file in the company's System-Design folder."
agent: "agent"
argument-hint: "Company name and HLD problem (e.g., PayPal Design a URL Shortener)"
---

Generate a comprehensive High-Level Design (HLD) / System Design solution. The user will provide the company name and the design problem.

## Output

Create the solution file at: `Companies/<CompanyName>/System-Design/HLD-<ProblemName>.md`
...
## Rules
- Tailor to Java/Spring Boot/Microservices ecosystem where applicable
- Explain **why** for every technology choice — don't just name-drop
- Keep the solution at Staff Engineer level — show breadth, depth, and trade-off thinking
